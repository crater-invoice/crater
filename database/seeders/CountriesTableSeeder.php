...
public function run()
{
	...
	$countries = array(
		...
		array('id' => 148,'code' => 'ME','name' => "Montenegro",'phonecode' => 382),
		array('id' => 149,'code' => 'MA','name' => "Morocco",'phonecode' => 212),
		array('id' => 150,'code' => 'MZ','name' => "Mozambique",'phonecode' => 258),
		array('id' => 151,'code' => 'MM','name' => "Myanmar",'phonecode' => 95),
		array('id' => 152,'code' => 'NA','name' => "Namibia",'phonecode' => 264),
		array('id' => 153,'code' => 'NR','name' => "Nauru",'phonecode' => 674),
		array('id' => 154,'code' => 'NP','name' => "Nepal",'phonecode' => 977),
		array('id' => 155,'code' => 'AN','name' => "Netherlands Antilles",'phonecode' => 599),
		array('id' => 156,'code' => 'NL','name' => "Netherlands The",'phonecode' => 31),
		array('id' => 157,'code' => 'NC','name' => "New Caledonia",'phonecode' => 687),
		array('id' => 158,'code' => 'NZ','name' => "New Zealand",'phonecode' => 64),
		...
		array('id' => 166,'code' => 'OM','name' => "Oman",'phonecode' => 968),
		array('id' => 167,'code' => 'PK','name' => "Pakistan",'phonecode' => 92),
		array('id' => 168,'code' => 'PW','name' => "Palau",'phonecode' => 680),
		array('id' => 169,'code' => 'PS','name' => "Palestinian Territory Occupied",'phonecode' => 970),
		array('id' => 170,'code' => 'PA','name' => "Panama",'phonecode' => 507),
		array('id' => 171,'code' => 'PG','name' => "Papua new Guinea",'phonecode' => 675),
		array('id' => 172,'code' => 'PY','name' => "Paraguay",'phonecode' => 595),
		array('id' => 173,'code' => 'PE','name' => "Peru",'phonecode' => 51),
		array('id' => 174,'code' => 'PH','name' => "Philippines",'phonecode' => 63),
		array('id' => 175,'code' => 'PN','name' => "Pitcairn Island",'phonecode' => 0),
		array('id' => 176,'code' => 'PL','name' => "Poland",'phonecode' => 48),
		array('id' => 177,'code' => 'PT','name' => "Portugal",'phonecode' => 351),
		array('id' => 178,'code' => 'PR','name' => "Puerto Rico",'phonecode' => 1787),
		array('id' => 179,'code' => 'QA','name' => "Qatar",'phonecode' => 974),
		array('id' => 180,'code' => 'RE','name' => "Reunion",'phonecode' => 262),
		array('id' => 181,'code' => 'RO','name' => "Romania",'phonecode' => 40),
		array('id' => 182,'code' => 'RU','name' => "Russia",'phonecode' => 70),
		array('id' => 183,'code' => 'RW','name' => "Rwanda",'phonecode' => 250),
		array('id' => 184,'code' => 'SH','name' => "Saint Helena",'phonecode' => 290),
		array('id' => 185,'code' => 'KN','name' => "Saint Kitts And Nevis",'phonecode' => 1869),
		array('id' => 186,'code' => 'LC','name' => "Saint Lucia",'phonecode' => 1758),
		array('id' => 187,'code' => 'PM','name' => "Saint Pierre and Miquelon",'phonecode' => 508),
		array('id' => 188,'code' => 'VC','name' => "Saint Vincent And The Grenadines",'phonecode' => 1784),
		array('id' => 189,'code' => 'WS','name' => "Samoa",'phonecode' => 684),
		array('id' => 190,'code' => 'SM','name' => "San Marino",'phonecode' => 378),
		array('id' => 191,'code' => 'ST','name' => "Sao Tome and Principe",'phonecode' => 239),
		array('id' => 192,'code' => 'SA','name' => "Saudi Arabia",'phonecode' => 966),
		array('id' => 193,'code' => 'SN','name' => "Senegal",'phonecode' => 221),
		array('id' => 194,'code' => 'RS','name' => "Serbia",'phonecode' => 381),
		array('id' => 195,'code' => 'SC','name' => "Seychelles",'phonecode' => 248),
		array('id' => 196,'code' => 'SL','name' => "Sierra Leone",'phonecode' => 232),
		array('id' => 197,'code' => 'SG','name' => "Singapore",'phonecode' => 65),
		array('id' => 198,'code' => 'SK','name' => "Slovakia",'phonecode' => 421),
		array('id' => 199,'code' => 'SI','name' => "Slovenia",'phonecode' => 386),
		array('id' => 200,'code' => 'XG','name' => "Smaller Territories of the UK",'phonecode' => 44),
		array('id' => 201,'code' => 'SB','name' => "Solomon Islands",'phonecode' => 677),
		array('id' => 202,'code' => 'SO','name' => "Somalia",'phonecode' => 252),
		array('id' => 203,'code' => 'ZA','name' => "South Africa",'phonecode' => 27),
		array('id' => 204,'code' => 'GS','name' => "South Georgia",'phonecode' => 0),
		array('id' => 205,'code' => 'SS','name' => "South Sudan",'phonecode' => 211),
		array('id' => 206,'code' => 'ES','name' => "Spain",'phonecode' => 34),
		array('id' => 207,'code' => 'LK','name' => "Sri Lanka",'phonecode' => 94),
		array('id' => 208,'code' => 'SD','name' => "Sudan",'phonecode' => 249),
		array('id' => 209,'code' => 'SR','name' => "Suriname",'phonecode' => 597),
		array('id' => 210,'code' => 'SJ','name' => "Svalbard And Jan Mayen Islands",'phonecode' => 47),
		array('id' => 211,'code' => 'SZ','name' => "Swaziland",'phonecode' => 268),
		array('id' => 212,'code' => 'SE','name' => "Sweden",'phonecode' => 46),
		array('id' => 213,'code' => 'CH','name' => "Switzerland",'phonecode' => 41),
		array('id' => 214,'code' => 'SY','name' => "Syria",'phonecode' => 963),
		array('id' => 215,'code' => 'TW','name' => "Taiwan",'phonecode' => 886),
		array('id' => 216,'code' => 'TJ','name' => "Tajikistan",'phonecode' => 992),
		array('id' => 217,'code' => 'TZ','name' => "Tanzania",'phonecode' => 255),
		array('id' => 218,'code' => 'TH','name' => "Thailand",'phonecode' => 66),
		array('id' => 219,'code' => 'TG','name' => "Togo",'phonecode' => 228),
		array('id' => 220,'code' => 'TK','name' => "Tokelau",'phonecode' => 690),
		array('id' => 221,'code' => 'TO','name' => "Tonga",'phonecode' => 676),
		array('id' => 222,'code' => 'TT','name' => "Trinidad And Tobago",'phonecode' => 1868),
		array('id' => 223,'code' => 'TN','name' => "Tunisia",'phonecode' => 216),
		array('id' => 224,'code' => 'TR','name' => "Turkey",'phonecode' => 90),
		array('id' => 225,'code' => 'TM','name' => "Turkmenistan",'phonecode' => 7370),
		array('id' => 226,'code' => 'TC','name' => "Turks And Caicos Islands",'phonecode' => 1649),
		array('id' => 227,'code' => 'TV','name' => "Tuvalu",'phonecode' => 688),
		array('id' => 228,'code' => 'UG','name' => "Uganda",'phonecode' => 256),
		array('id' => 229,'code' => 'UA','name' => "Ukraine",'phonecode' => 380),
		array('id' => 230,'code' => 'AE','name' => "United Arab Emirates",'phonecode' => 971),
		array('id' => 231,'code' => 'GB','name' => "United Kingdom",'phonecode' => 44),
		array('id' => 232,'code' => 'US','name' => "United States",'phonecode' => 1),
		array('id' => 233,'code' => 'UM','name' => "United States Minor Outlying Islands",'phonecode' => 1),
		array('id' => 234,'code' => 'UY','name' => "Uruguay",'phonecode' => 598),
		array('id' => 235,'code' => 'UZ','name' => "Uzbekistan",'phonecode' => 998),
		array('id' => 236,'code' => 'VU','name' => "Vanuatu",'phonecode' => 678),
		array('id' => 237,'code' => 'VA','name' => "Vatican City State (Holy See)",'phonecode' => 39),
		array('id' => 238,'code' => 'VE','name' => "Venezuela",'phonecode' => 58),
		array('id' => 239,'code' => 'VN','name' => "Vietnam",'phonecode' => 84),
		array('id' => 240,'code' => 'VG','name' => "Virgin Islands (British)",'phonecode' => 1284),
		array('id' => 241,'code' => 'VI','name' => "Virgin Islands (US)",'phonecode' => 1340),
		array('id' => 242,'code' => 'WF','name' => "Wallis And Futuna Islands",'phonecode' => 681),
		array('id' => 243,'code' => 'EH','name' => "Western Sahara",'phonecode' => 212),
		array('id' => 244,'code' => 'YE','name' => "Yemen",'phonecode' => 967),
