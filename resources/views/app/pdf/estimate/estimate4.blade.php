...
<div class="header-container">
    <table width="100%">
        <tr>
            <td width="33%" class="data-container company-data">
                <p>
                    E-mail: lowie@lowieanthonissen.be <br/>
                    Tel: +32 468 56 69 54 <br/>
                    <br/>
                    Bank: BE95 9733 7974 7758 <br/>
                    KBO NR: 0748.511.980
                </p>
            </td>
            ...
            <td width="33%" class="text-right company-address-container company-address">
                {!! $company_address !!}
            </td>
        </tr>
    </table>
    ...
    <div class="main-content">
        <div class="customer-address-container">
            <div class="billing-address-container billing-address">
                @if ($billing_address)
                    {!! $billing_address !!} <br>
                    @if ($estimate->customer->btw)
                        { $estimate->customer->btw }
                    @endif
                @endif
            </div>
